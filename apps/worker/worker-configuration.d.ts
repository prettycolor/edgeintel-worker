/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 882d96148f40229234ff20fa53007859)
// Runtime types generated with workerd@1.20260409.1 2026-04-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JobCoordinator";
	}
	interface Env {
		...
		SCAN_WORKFLOW: Workflow<Parameters<import("./src/index").EdgeIntelScanWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SCAN_BATCH_LIMIT" | "SCAN_QUEUE_NAME" | "ARTIFACT_QUEUE_NAME" | "AI_GATEWAY_ID" | "AI_GATEWAY_BASE_URL" | "AI_GATEWAY_MODEL" | "AI_GATEWAY_PROVIDER" | "AI_INFERENCE_DEFAULT_ROUTE" | "BROWSER_RENDERING_REST_BASE_URL" | "ACCESS_ALLOW_DEV_BYPASS" | "PAIRING_TOKEN_TTL_SECONDS" | "CONNECTOR_TOKEN_TTL_SECONDS">> {}
}
